...
cy.add([
  ...
  { group: 'edges', data: { source: '079', target: '237', motif: "nightmare" }, classes: ["weak"] },
  ...
  { group: 'edges', data: { source: '139', target: '308', motif: "dont"}, classes: ["weak"] },
  ...
  { group: 'edges', data: { source: '239', target: '327', motif: "bigshot" }, classes: ["weak"] },
...
function autocomplete(inp, arr) {
  ...
  inp.addEventListener("input", function(e) {
      ...
      for (i = 0; i < arr.length; i++) {
        ...
        if (arr[i].substring(0, val.length).toLowerCase() == val.toLowerCase()) {
...
function fullMotif(m) {
    switch (m) {
      ...
      case "darktruth": mn = "Dark Truth"; break;
      default: mn = m;
    }
    return mn;
}
